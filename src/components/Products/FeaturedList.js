...
export default function FeaturedList() {
  ...
  // Filter the products based on the 'type' field
  const filteredProducts = data.filter((product) => product.type === 'flower');

  return (
    <>
      {!filteredProducts.length && loading ? (
        <>
          <p>Loading flower products...please wait.</p>
        </>
      ) : (
        <>
          {filteredProducts.length ? (
            ...
            <p>No flower products available.</p>
          )}
        </>
      )}
    </>
